...
// in1 - glider on 10x10
// in2 - glider on 25x25
void test0() { test("myin", 10); }
//void test0() { test( "in0", 10 ); }     
void test1() { test( "input/in0", 11 ); }
void test2() { test( "input/in0", 100 ); }
void test3() { test( "input/in0", 101 ); }
void test4() { test( "input/in1", 10 ); }
void test5() { test( "input/in1", 11 ); }
void test6() { test( "input/in1", 24 ); }
void test7() { test( "input/in2", 84 ); }
